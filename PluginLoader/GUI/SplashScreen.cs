...
namespace MEPluginLoader.GUI
{
    public class SplashScreen : Form
    {
        ...
        public SplashScreen()
        {
            if (Application.OpenForms.Count == 0 || !TryLoadImage(out Image gif))
            {
                invalid = true;
                return;
            }
            ...
            Name = "SplashScreenMEPluginLoader";
            TopMost = true;
        ...
        private bool TryLoadImage(out Image img)
        {
            try
            {
                ...
                Stream myStream = myAssembly.GetManifestResourceStream("MEPluginLoader.splash.gif");
